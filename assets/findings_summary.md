...
- The override is NOT learnable at quote time (GroupKFold R2 -0.07 vs best baseline; direction AUC 0.57): estimators use information the system doesn't capture — a data gap, and the case for capturing override reasons in the MIS.
