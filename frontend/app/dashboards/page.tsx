...
export default async function DashboardsPage() {
  ...
  const tiles: Tile[] = [
    ...
    },
    {
      ...
      changes: `Quotes expected to run past ${th.crossover_hrs.toFixed(1)}h get checked against the ${gbp(th.benchmark_rate_gbp_per_hr)}/hr average before they go out. A review trigger, not a rule: big runs carry the factory's fixed costs and an hour at a lower rate still beats an idle hour, so this is about pricing large work knowingly wherever there is room to.`,
      figure: fRate,
      wide: true,
    },
    {
